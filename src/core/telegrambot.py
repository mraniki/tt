...
class TelegramBot:
    ...
    def _prepare(self):
        ...
        def process_trade_selection(update, bot, user_data):
        ...
        def process_order_cancel(update, bot, user_data):
        ...
        def process_percent(update, bot, user_data):
        ...
        def process_price(update, bot, user_data):
        ...
        def process_trade(update, bot, user_data):
            query = update.callback_query
        ...
        def handle_error(update, bot, error):
